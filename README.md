...
* Solid World: publish aproved agenda with input from the various stakeholders, prepare the speakers and the visuals before the webinar,  and host the webinar using the approved script with the support of one team member for technical matters and live tweeting by with support of another team member 
...
* Solid Twitter: publish tweets including upcoming Solid World and published This Month in Solid as well as coordinating live tweeting during Solid World with supoort of a team member 
