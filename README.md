...
The Solid Director approves process proposals and role applications which amount to all pull requests in this repository except in [panels.md](https://github.com/solid/culture/blob/master/panels.md) and [stakeholders.md](https://github.com/solid/culture/blob/master/stakeholders.md). 

The Solid Manager is appointed by the Solid Director and is responsible for implementing the [approved processes](https://github.com/solid/culture) with the appointed individuals in the [editor](https://github.com/solid/culture/blob/master/editors.md), [administrator](https://github.com/solid/culture/blob/master/administrators.md), [panelist](https://github.com/solid/culture/blob/master/panels.md) and [stakeholder](https://github.com/solid/culture/blob/master/stakeholders.md) roles. 
